...
namespace Dialogue.Editor
{
    ...
    {
        public DialogueObject currentDialogueContainer;                           // Current open dialouge container in dialogue editor window.
        ...
        public static bool ShowWindow(int instanceId, int line)
        {
            ...
            if (item is DialogueObject)    // Check if item is a DialogueObject Object.
            {
                ...
                window.currentDialogueContainer = item as DialogueObject;                                  // The DialogueObject we will load in to editor window.
                window.minSize = new Vector2(500, 250);                                                         // Starter size of the editor window.
                window.Load();                                                                                  // Load in DialogueObject data in to the editor window.
            }
